...
class NOHCustomListCategories extends Module
{
		
	public function __construct()
	{
		$this->name = 'NOHCustomListCategories';
		$this->tab = 'others';
		...
		$this->displayName = $this->l('Listado/menú de categorias adaptado 00');
	...
	*/
	...
	{	 	
        ...
        Configuration::updateValue('NOHCL2C_Categories', '');
	...
	{				
		$lista = array();
		if (Configuration::get('NOHCL2C_Categories') != "")
			$lista = explode("|", Configuration::get('NOHCL2C_Categories'));
		...
		if (count($lista > 0))
		{
			...
			return $this->display(__FILE__, 'NOHCustomListCategories.tpl');
	...
	public function uninstall()
	{
		...
		Configuration::deleteByName('NOHCL2C_Categories');
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('titulo'))
		{
			...
			Configuration::updateValue('NOHCL2C_Categories', $nuevaLista);
		...
		$output .= '<script type="text/javascript">
					...
					function envioFormulario()
					{
						...
						document.getElementById('."'formularioLista00'".').submit();
...
//-->
			...
			$output.= '<center><form method="post" action="'.$_SERVER['REQUEST_URI'].'" enctype="multipart/form-data" id="formularioLista00">
